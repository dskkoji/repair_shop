INSERT INTO tickets (
  ...
  (
    1, 'Slow computer performance', 'Costomer mentioned that their computer is running very slowly.', false, 'unassinged', now(), now()
  ),
  (
  ...
  (
    2, 'Data recovery', 'Customer accidentally deleted important files and need data recovery.', false, 'unassigned', now(), now()
  ),
  (
  ...
  (
    5, 'Blue screen error', 'Customer''s computer is showing a blue screen error frequetly.', false, 'unassigned', now(), now()
  ),
  (
