...
export const insertCustomerSchema = createInsertSchema(customers, {
  firstName: (schema) => schema.firstName.min(1, "First name is requied"),
  ...
  zip: (schema) => schema.zip.regex(/^\d{5}(-\d{4})?$/, "Invalid Zip code. Use 5 digits followed by a hyphen and 4 digits"),
